    ...
    <div :class="wrapClasses" :style="styles">
        <div :class="classes">
            ...
            <div data-type="scroll"
                :class="[prefixCls + '-body']" :style="bodyStyle" ref="body" @mousewheel="handleBodyWheel" @scroll="handleBodyWheel"
                ...
                <table-body
                    ...
                    :columns="cloneColumns"
                    :data="rebuildData"
                    :dataShowed="lazyShowData.show ? lazyShowData.data : rebuildData"
                    :columns-width="columnsWidth"
            ...
            <div :class="[prefixCls + '-fixed']" :style="fixedTableStyle" v-if="isLeftFixed">
                ...
                <div data-type="scroll" 
                    :class="[prefixCls + '-fixed-body']" :style="fixedBodyStyle" ref="fixedBody" @mousewheel="handleFixedMousewheel" @DOMMouseScroll="handleFixedMousewheel">
                    <table-body
                        fixed="left"
                        :prefix-cls="prefixCls"
                        :styleObject="fixedTableStyle"
            ...
            <div :class="[prefixCls + '-fixed-right']" :style="fixedRightTableStyle" v-if="isRightFixed">
                ...
                <div data-type="scroll" 
                    :class="[prefixCls + '-fixed-body']" :style="fixedBodyStyle" ref="fixedRightBody" @mousewheel="handleFixedMousewheel" @DOMMouseScroll="handleFixedMousewheel">
                    <table-body
                        fixed="right"
                        :prefix-cls="prefixCls"
                        :styleObject="fixedRightTableStyle"
...
<script>
    ...
    import mixinLazyshow from './mixin-lazyshow';
...
//                    const width = this.bodyHeight === 0 ? this.tableWidth : this.tableWidth - this.scrollBarWidth;
        ...
        methods: {
            ...
            fixedBody (){
                ...
                if ((!this.$refs.tbody || !this.data || this.data.length === 0) && !this.lazyShowData.show) {
                    ...
                    this.showVerticalScrollBar = 
                        this.lazyShowData.show
                        ? true 
                        : (this.bodyHeight? bodyHeight - (this.showHorizontalScrollBar?this.scrollBarWidth:0) < bodyContentHeight : false);
            ...
            handleBodyScroll (event) {
                if(event.target.getAttribute('data-type') !== 'scroll') return;
            ...
            handleFixedMousewheel(event) {
                ...
                this.lazyShowData.show && this.stretchEdge(event);
