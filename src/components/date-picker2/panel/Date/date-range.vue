        ...
        <div :class="panelBodyClasses">
            <div :class="[prefixCls + '-content', prefixCls + '-content-left']" v-show="!isTime">
                ...
                <component
                    ...
                    :disabled-date="splitPanels ? (date) => {return disableDate_splitMode(date, 'left')} : disabledDate"
            ...
            <div :class="[prefixCls + '-content', prefixCls + '-content-right']" v-show="!isTime">
                ...
                <component
                    ...
                    selection-mode="range"
                    :range-state="rangeState"
                    :disabled-date="splitPanels ? (date) => {return disableDate_splitMode(date, 'right')} : disabledDate"
                    :show-week-numbers="showWeekNumbers"
...
<script>
    ...
    const prefixCls = 'ivu-picker-2-panel';
    const datePrefixCls = 'ivu-date-picker-2';
