...
<script>
    ...
    import iDropdownMenu from '../../components/dropdown/dropdown-menu.vue';
    ...
    export default {
        ...
        components: { iInput, Drop, iDropdown, iDropdownMenu },
        ...
        computed: {
            wrapperClasses(){
                return [prefixCls, {
                    ...
                    [prefixCls + '-shortcut-dropdown']: this.shortcutMenu.length
                }];
            },
            publicVModelValue(){
                if (this.multiple){
