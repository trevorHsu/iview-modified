...
<template>
    <div>
        <br><br><br><br><br>
        <!-- <TableLazy border :show-header='false' :columns="columns1" height="500" :data="data1"></TableLazy> -->
        <TableLazy border :columns="columns1" :data="data1" height='500' :lazyShow="20" @on-select="printSelectedItem"></TableLazy>
        <br><br><br><br><br>
        <TableLazy width="550" height="200" border :columns="columns2" :data="data4"></TableLazy>
        <!-- <br><br><br><br><br> -->
            ...
            <Layout :style="{minHeight: '80vh'}">
                ...
                <Layout class-name="test-class">
                    ...
                    <Content :style="{background:'#FFCF9E'}">
                        <TableLazy border :columns="columns8"  height="240" :data="data7"></TableLazy>
                    </Content>
