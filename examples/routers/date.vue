...
<template>
    <div style="width: 500px;margin: 100px;">
        ...
        <DatePicker type="daterange" transfer placeholder="Select date" style="width: 400px"></DatePicker>
        <DatePicker type="daterange" confirm transfer show-week-numbers placeholder="Select date" style="width: 400px"></DatePicker>
        <DatePicker type="datetimerange" split-panels transfer show-week-numbers placeholder="Select date" style="width: 400px"></DatePicker>
